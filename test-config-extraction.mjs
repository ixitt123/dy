...
assert.deepEqual(DEFAULT_MODEL_MAPPING.image, { provider: "volcengine_ark", model: DEFAULT_VOLCENGINE_ARK_IMAGE_MODEL });
assert.equal(DEFAULT_VOLCENGINE_ARK_IMAGE_MODEL, "doubao-seedream-5-0-lite-260128");
assert.equal(SETTINGS_TASKS.image.label, "图片生成");
