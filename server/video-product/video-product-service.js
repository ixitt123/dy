  ...
  function listSources() {
    ...
    return {
      ...
      bgmProviderSuggestions: [
        { id: "hifive", label: "HIFIVE 音加加 / 曲多多", status: "domestic_paid_first", note: "国内正版曲库优先候选，通常支持支付宝/微信等国内付款方式；按短视频、平台、期限、曲目数量和 API 接入商务报价。" },
        { id: "vfine", label: "Vfine Music", status: "domestic_paid", note: "国内商用版权音乐候选，适合企业宣传、广告和短视频；申请企业/API 服务后保存授权证明再自动入库。" },
        { id: "kanjian_starlink", label: "看见音乐 STARLINK", status: "domestic_paid", note: "面向平台/API/SDK 的正版音乐服务，适合需要批量配乐、全球版权或短剧场景音乐的流程。" },
        { id: "tme_opencloud", label: "腾讯音乐音乐云", status: "domestic_enterprise", note: "企业级商用曲库、音乐定制和版权保护方案，通常需要商务开通和按项目/套餐报价。" },
        { id: "jamendo", label: "Jamendo", status: "free_backup_license_review", note: "海外免费/备用 API；只在授权可确认、BPM 合规时自动使用，商业视频仍要保存授权信息。" },
      ],
