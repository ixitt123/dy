...
<body>
  ...
  <script>
    ...
    tl.from("#title-scene h1",{y:28,opacity:0,duration:.42,ease:"power3.out"},.18)
      ...
      .fromTo(".hero-halo",{opacity:0,scale:.82},{opacity:.78,scale:1,duration:.42,stagger:.08,ease:"sine.out"},.12)
      .to(".hero-halo",{opacity:.76,duration:.62,ease:"none"},.58)
