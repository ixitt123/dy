...
const ITEM_PROFILES = {
  ...
  "R2-02.01": { mode: "security-dynamic", test: "test-fast-uri-host-confusion.mjs", commands: ["node test-fast-uri-host-confusion.mjs"] },
  "R2-02.02": { mode: "security-dynamic", test: "test-ip-address-leading-zero.mjs", commands: ["node test-ip-address-leading-zero.mjs", "node test-ssrf-guard.mjs"] },
  ...
  "R2-02.05": { mode: "security-dynamic", test: "test-hono-cors-redos.mjs", commands: ["node test-hono-cors-redos.mjs"] },
  "R2-02.06": { mode: "security-dynamic", test: "test-brace-expansion-dos.mjs", commands: ["node test-brace-expansion-dos.mjs"] },
