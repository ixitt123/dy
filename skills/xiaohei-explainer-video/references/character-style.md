...
用户要的是“比旧小黑更讨喜、更有动画感的主角”，不是复刻某个已有 IP。把用户提到的“动画大片感、收藏玩偶感、类似潮玩角色的吸引力”翻译成原创视觉语言。
...
```text
an original cinematic 3D animated collectible character, matte black and charcoal body, soft vinyl and plush texture, rounded head-body proportions, expressive glossy eyes with tiny catchlights, short arms and legs, playful but serious personality, slightly mischievous posture, clean white studio background, hand-drawn black structure lines and sparse Chinese annotations around it, original silhouette, not based on any existing character
```

中文可写：

```text
原创 3D 动画感收藏玩偶主角，黑色与深炭色软胶/绒感材质，圆润头身比例，大而清澈的眼睛带小高光，短手短腿，认真但有一点调皮，动作明确地参与画面核心工作，白底，周围是黑色手绘结构线和少量中文手写批注，原创轮廓，不复刻任何已有角色。
```

## Shape Language

- Head/body: one compact rounded silhouette, not a stick figure.
- Eyes: large, clear, reflective, emotionally readable.
- Mouth: optional and tiny; avoid sharp branded tooth shapes.
...
```json
{
  "identity_anchor": "matte black rounded 3D toy protagonist with glossy eyes",
